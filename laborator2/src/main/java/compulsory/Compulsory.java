...
public class Compulsory {
    ...
    public void main()
    {
        ...
        Road r3 = new Road("Brasovia", RoadType.EXPRESS, euclidianDistance(l2.getX(), l2.getY(), l4.getX(), l4.getY()), 70, l2, l4);

        Road r4 = new Road("Bulevard Dacia", RoadType.COUNTY, euclidianDistance(l4.getX(), l4.getY(), l3.getX(), l3.getY()), 50, l4, l3);
